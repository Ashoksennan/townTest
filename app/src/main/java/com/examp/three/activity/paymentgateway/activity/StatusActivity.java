...
import static com.examp.three.common.Common.METHOD_NAME_SAVE_PROFESSION;
import static com.examp.three.common.Common.METHOD_NAME_SAVE_PROPERTY;
...
//        TODO:     Dont forget to comment during production
    ...
    public void savePropProfToCollection() {
        ...
        if (taxType.equalsIgnoreCase("P")) {
            URL_SAVE =  METHOD_NAME_SAVE_PROPERTY + "?" + "district=" + districtName +
            ...
            URL_SAVE =  METHOD_NAME_SAVE_PROFESSION + "?" + "district=" + districtName +
                    "&panchayat=" + tempPanchayat + "&assessmentNo=" + assessmentNumber +
                    "&assessmentName=" + URLEncoder.encode(assessmentName) +
                    "&financialYear=" + financialYear +
    ...
    public void saveWaterToCollection() {
        ...
        String URL_SAVE = Common.METHOD_NAME_SAVE_WATER + "?" +
    ...
    public void saveOnlineTransDetails() {
        ...
        try {
            ...
            URL_SAVE_ONLINE_TRANS = Common.METHOD_NAME_SAVE_ONLINE_TRANS + "?" +
