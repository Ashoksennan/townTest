...
//        builder.setTitle("Registration successful");
    ...
    private void getNonTaxBalanceDetails() {
        String URL_ASSESS_DETAILS = Common.METHOD_NAME_GET_NONTAXBAL_DETAILS;
...
//                            System.out.println("jsonArray = " + jsonArray);
    ...
    private void getWaterBalanceDetails() {
        String URL_ASSESS_DETAILS =Common.METHOD_NAME_GET_WATERBAL_DETAILS;
...
//                            if (!jsonArray.equals("[]")) {
    ...
    public void getpropertyDemand() {
        String URL_ASSESS_DETAILS =  Common.METHOD_NAME_GET_PPBAL_DETAILS;
...
//        amountToBePaid = totalDemandAmount + transactionCost + serviceCharge + bankCharges;
    ...
    public void getOrderId() {
        String URL_ASSESS_DETAILS = Common.METHOD_NAME_GET_ORDERID;
...
//            tempTaxStreetName = URLEncoder.encode(TaxStreetName, "UTF-8");
            ...
            URL_SAVE_ONLINE_TRANS =  Common.METHOD_NAME_SAVE_ONLINE_BEFORE_TRANS + "?" +
