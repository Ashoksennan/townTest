...
//        userId = LoginActivity.user_id;
    ...
    public void addAssessment(String district, String panchayat, final String taxType, String taxNo, String taxName,
        ...
        String URL_ADD = Common.METHOD_NAME_SAVE_ADD_TAX_DETAILS + "?" +
                "district=" + district + "&"+ "panchayat=" + tempPanchayat +
                Common.PARAMETER_SEPERATOR_AMP + "taxType=" + taxType +"&" +
                "taxNo=" + taxNo + "&"+ "taxName=" + tempName +
                "&" + "userId=" + userId;
    ...
    public void checkTaxNo(String district, String panchayat, String taxType, String taxNo) {
        ...
        String URL_CHECK_TAX_NO = Common.METHOD_NAME_CHECK_TAX_DETAILS + "?" +
