...
public class NewAssessment_Third_Fragment extends Fragment {
    ...
    public void onClicks() {
        ...
        tvUploadRegDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (tvChooseRegDoc.getText().toString().equalsIgnoreCase("Choose File")) {
        ...
        tvUploadParentDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (tvChooseParentDoc.getText().toString().equalsIgnoreCase("Choose File")) {
                    Snackbar.make(rootLayout, "Choose File First  !", Snackbar.LENGTH_SHORT).show();
                }  else {
        ...
        tvUploadPattaDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (tvRegChoosePattaDoc.getText().toString().equalsIgnoreCase("Choose File")) {
                    Snackbar.make(rootLayout, "Choose File First  !", Snackbar.LENGTH_SHORT).show();
                }  else {
